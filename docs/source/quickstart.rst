...
See the `/examples <https://github.com/DhayaaAnbajagane/Baryonification/blob/main/examples/>`_ folder in the Github repo for more notebooks demonstrating how to use the code for different applications.
